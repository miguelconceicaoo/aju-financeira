<?php
    ...
    if(!empty($_GET['id'])){
        ...
        $id = $_GET['id'];
        $sql = "SELECT cnh FROM cliente WHERE id='$id'";
...
<body>
    <div class="containe">
        ...
        <div class="main">
            ...
            <div class="form1">
                <div class="form2">
                    <form action="salvar_cnh.php?id=<?php echo $id; ?>&id_servico=<?php echo $id_servico; ?>&cpf=<?php echo $cpf; ?>" method="POST" enctype="multipart/form-data">
                        <h2>CNH - Carteira nacional de habilitação </h2>
                
                        <div class="form-group">
                            <input type="file" name="cnh" id="cnh " class="form-control-file border" accept="image/*"><br>
...
<script>
    var imagem = document.querySelector('[name=cnh]')
