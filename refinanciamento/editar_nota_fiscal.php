<?php
    ...
    if(!empty($_GET['id_servico'])){
        ...
        $sql = "SELECT nota_fiscal FROM servico WHERE id_servico = '$id_servico'";
...
<body>
    <div class="containe">
        ...
        <div class="main">
            ...
            <div class="form1">
                <div class="form2">
                    <form action="salvar_nota_fiscal.php?id=<?php echo $id; ?>&id_servico=<?php echo $id_servico; ?>&cpf=<?php echo $cpf; ?>" method="POST" enctype="multipart/form-data">
                        <h2>Nota fiscal</h2>
                
                        <div class="form-group">
                            <input type="file" name="notafiscal" id="notafiscal" class="form-control-file border" accept="image/*"><br>
...
<script>
    var imagem = document.querySelector('[name=notafiscal]')
