...
<head>
    ...
    <title>Alterar carteira de identidade</title>
...
<body>
    <div class="containe">
        ...
        <div class="main">
            ...
            <div class="form1">
                <div class="form2">
                    <form action="salvar_identi_frente.php?id=<?php echo $id; ?>&id_servico=<?php echo $id_servico; ?>&cpf=<?php echo $cpf; ?>" method="POST" enctype="multipart/form-data">
                        <h2>Carteira de identidade - Frente</h2>
                
                        <div class="form-group">
                            <input type="file" name="identidadefrente" id="identidadefrente" class="form-control-file border" accept="image/*"><br>
                            <img src="../img/def.png" class='rounded' id="imagem" alt="" data-toggle="modal" data-target="#myModal" width="150px" height="150px">
                        </div>

                        <div class="form-group">
                            <input type="hidden" name="id" value="<?php echo $id ?>">
                            <input type="submit" name="alterar" id="alterar" class="btn btn-success" value="Alterar">  
                            <?php echo"<a href='upload_refinanciamento.php?id=$id&id_servico=$id_servico&cpf=$cpf'><input type='button' value='Voltar' class='btn btn-primary'></a>";?>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    var imagem = document.querySelector('[name=identidadefrente]')
