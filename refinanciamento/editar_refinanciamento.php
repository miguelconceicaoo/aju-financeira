...
<head>
    ...
    <title>Alterar dados refinanciamento</title>  
...
<body>
    <div class="containe">
        ...
        <div class="main">
            ...
            <div class="form1">
                <div class="form2">
                <form action="salvar_refinanciamento.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cep" id="cep" maxlength="9" placeholder="(00) 0 0000-0000" class="form-control" value="<?php echo $cep ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefonereferencia" id="telefonereferencia" placeholder="(00) 0 0000-0000" class="form-control" value="<?php echo $telefone_referencia ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefonetrabalho" maxlength="14" id="telefonetrabalho" placeholder="(00) 0 0000-0000" class="form-control" value="<?php echo $telefone_trabalho ?>">
                </div>

                <div class="form-group">
                    <label for="renda">Renda bruta:</label>
                    <input type="text" name="renda" id="renda" class="form-control" value="<?php echo $renda ?>">
                </div>
