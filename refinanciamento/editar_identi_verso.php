...
<body>
    <div class="containe">
        ...
        <div class="main">
            ...
            <div class="form1">
                <div class="form2">
                    <form action="salvar_identi_verso.php?id=<?php echo $id; ?>&id_servico=<?php echo $id_servico; ?>&cpf=<?php echo $cpf; ?>" method="POST" enctype="multipart/form-data">
                        <h2>Carteira de identidade - Verso</h2>
                
                        <div class="form-group">
                            <input type="file" name="identidadeverso" id="identidadeverso" class="form-control-file border" accept="image/*"><br>
                            <img src="../img/def.png" id="imagem" alt="" class='rounded' width="150px" height="150px">
                        </div>
...
<script>
    var imagem = document.querySelector('[name=identidadeverso]')
