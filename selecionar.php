...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="box">
                <div class="title">
                    <div class="numbers"><h3>Selecione o tipo de serviço</h3></div>
                </div>
            </div>
            ...
            <div class="cardBox">
                <div class="card">
                    <div>
                        <a href="emprestimo/form_emprestimo.php"><div class="numbers">Empréstimo consignado</div></a>
                ...
                <div class="card">
                    <div>
                        <a href="financiamento/form_financiamento.php"><div class="numbers">Financiamento</div></a>
                        <div class="cardName"></div>
                    </div>
                    <div class="iconBx">
                ...
                <div class="card">
                    <div>
                        <a href="refinanciamento/form_refinanciamento.php"><div class="numbers">Refinanciamento</div></a>
                        <div class="cardName"></div>
                    </div>
                    <div class="iconBx">
                ...
                <div class="card">
                    <div>
                        <a href="antecipacao/form_antecipacao.php"><div class="numbers">Antecipação de FGTS</div></a>
                        <div class="cardName"></div>
                    </div>
                    <div class="iconBx">
