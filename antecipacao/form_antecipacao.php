...
<head>
    ...
    <title>Formulário antecipação de FGTS</title>
                ...
                <div class="form2">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="agencia" id="agencia" class="form-control" maxlength="4" placeholder="0000" autocomplete="off">
                        </div>
        
                        <div class="form-group">
                            <label for="numeroconta">Número da conta:</label>
                            <input type="text" name="numeroconta" id="numeroconta" class="form-control" maxlength="10" placeholder="00000000-0" autocomplete="off">
                        </div>
                    ...
                    <?php
                        ...
                        if(isset($_POST['nome']) and isset($_POST['rg']) and isset($_POST['cpf']) and isset($_POST['email']) and isset($_POST['datanascimento']) 
                        and isset($_POST['endereco']) and isset($_POST['cep']) and isset($_POST['telefonecelular']) and isset($_POST['telefonefixo'])
                        and isset($_POST['nomebanco']) and isset($_POST['agencia']) and isset($_POST['numeroconta']) and isset($_POST['tipoconta'])){
                            ...
                            $sql = "INSERT INTO cliente (nome,rg,cpf,email_cliente,data_nascimento,endereco,cep,telefone,telefone_fixo) 
                            VALUES ('$nome','$rg','$cpf','$email','$data_nascimento','$endereco','$cep','$telefone_celular','$telefone_fixo')";
                            ...
                            $_SESSION["tipo_servico"]='antecipacao';
