                    ...
                    <tbody>
                        <?php
                            if(!empty($_GET['id'])){
                                ...
                                $id = $_GET['id'];
                                $sql = "SELECT identidade_frente, identidade_verso, protocolo_pagamento, nota_fiscal FROM cliente,servico WHERE cliente.id='$id' and servico.id_servico='$id_servico'";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    ...
                                    echo"<tr>";
                                        echo"<th>Protocolo de pagamento</th>";
                                        echo"<th>Nota fiscal</th>";
                                    echo"</tr>";

                                    echo"<tr>";
                                    echo"<td>";
                                        echo "<img src='".$protocolo_pagamento."' alt='Nenhum arquivo inserido' width='300px' heigth='300px' class='rounded' data-toggle='modal' data-target='#myModal2'><br><br>";
                                        echo"<a href='editar_protocolo_pagamento.php?id=$id&id_servico=$id_servico&cpf=$cpf'><button class='btn-sm btn-outline-primary'>Editar</button></a> "; 
                                        echo"<a href='excluir_protocolo_pagamento.php?id=$id&id_servico=$id_servico&cpf=$cpf' onclick=\"return confirm('Tem certeza que deseja deletar essa imagem?'); return false;\"><button class='btn-sm btn-outline-danger'>Excluir</button></a>";  
                                    echo"</td>";
                                    ...
                                    header("Location: consult_antecipacao.php");      
                                }   
                            }
                        ?>
                    </tbody>
  ...
  <div class="modal fade" id="myModal2">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <img src="<?php echo $protocolo_pagamento?>" alt="" id="imgmodal" width="100%" height="100%">
        </div>
