...
<head>
    ...
    <title>Alterar identidade</title>
                ...
                <div class="form2">
                    <form action="salvar_identi_frente.php?id=<?php echo $id; ?>&id_servico=<?php echo $id_servico; ?>&cpf=<?php echo $cpf; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo"<a href='upload_financiamento.php?id=$id&id_servico=$id_servico&cpf=$cpf'><input type='button' value='Voltar' class='btn btn-primary'></a>";?>
                        </div>
                    </form>
                </div>
            </div>
