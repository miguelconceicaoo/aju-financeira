...
<head>
    ...
    <title>Formulário financiamento</title>
        ...
        <div class="main">
            ...
            <div class="form1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="naturalidade" maxlength="20" id="naturalidade" placeholder="Digite a naturalidade" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomemae" maxlength="20" id="nomemae" placeholder="Digite o nome da mãe" class="form-control">
                </div>

                <div class="form-group">
                    <label for="endereco">Endereço residencial:</label>
                    <input type="text" name="endereco" maxlength="60" id="endereco" placeholder="Digite o endereço" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefonereferencia" maxlength="14" id="telefonereferencia" maxlength="14" placeholder="(00) 0 0000-0000" class="form-control">
                </div>
