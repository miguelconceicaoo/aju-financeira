...
<body>
    <div class="">
        ...
        <div class="main">
            ...
            <div class="box">
                <div class="title">
                    <div class="numbers"><h1>Adicionar serviço - Financiamento</h1></div>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php
                                ...
                                while($user = mysqli_fetch_assoc($result)){
                                    ...
                                    echo"<td>
                                        <a href='adicionar_financiamento.php?id=$user[id]&cpf=$user[cpf]'>
...
<script>
    ...
    function searchData(){
        window.location = 'consult_adicionar_financiamento.php?search='+search.value;
    }
</script>
